...
import { ReactionStatusLabel } from "../../enums/ReactionStatusEnum";
  ...
  return (
    <div>
      ...
      <div className="max-w-xl mx-auto mt-8 p-4 bg-white dark:bg-slate-800 rounded shadow">
        ...
        <div className="mb-2">
          <strong>User:</strong> {reaction.user?.name}
        </div>
        <div className="mb-2">
          <strong>Title:</strong> {reaction.title}
        </div>
        <div className="mb-2">
          <strong>Video Type:</strong> {VideoTypeLabel[reaction.type_video]}
        </div>
        <div className="mb-2">
          <strong>Status:</strong> {ReactionStatusLabel[reaction.status]}
        </div>
        <div className="mb-2">
          <strong>Due Date:</strong>{" "}
          {reaction.due_date
            ? new Date(reaction.due_date).toLocaleString()
            : "-"}
        </div>
      </div>
